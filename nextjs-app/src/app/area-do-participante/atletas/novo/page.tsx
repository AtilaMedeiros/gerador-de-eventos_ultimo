...
import { Save, User, FileText, Shield, Loader2, X, Trophy } from 'lucide-react'
...
export default function AthleteFormPage() {
    ...
    const editingAthlete = isEditing ? athletes.find(a => a.id === id) : null
    ...
    const onSubmit = async (data: AthleteFormValues) => {
        ...
        try {
            ...
            router.push('/area-do-participante/atletas')
            router.refresh()
        } catch (error) {
            console.error(error)
        ...
        <div className="max-w-full mx-auto h-[calc(100vh-5rem)] flex flex-col animate-fade-in">
            ...
            <div className="flex items-center justify-between mb-6 shrink-0">
                ...
                <div className="flex gap-2">
                    <Button
                        variant="outline"
                        onClick={() => router.push('/area-do-participante/atletas')}
                        ...
                        <form className="space-y-6">
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input type="date" {...field} className="w-full md:w-[180px]" />
                                                </FormControl>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <FormDescription>Deve ser único.</FormDescription>
                                                <FormMessage />
                                            </FormItem>
                                        )}
                                    />
                            ...
                            <div className="space-y-4 p-5 border rounded-xl bg-card shadow-sm">
                                <div className="flex items-center gap-2 mb-2 border-b pb-2">
                                    ...
                                    <h3 className="font-semibold text-lg">Responsável Legal</h3>
                                </div>

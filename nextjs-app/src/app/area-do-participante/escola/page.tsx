...
export default function SchoolProfile() {
    ...
    const isResponsible = true // Always allow edit for now
    ...
    useEffect(() => {
        if (school) {
            form.reset({
                ...
                cnpj: school.cnpj || '00.000.000/0000-00',
                address: school.address || 'Rua Principal, 123',
                neighborhood: school.neighborhood || 'Centro',
                cep: school.cep || '60000-000',
                type: school.type || 'Publica',
                sphere: school.sphere || 'Municipal',
                landline: school.landline || '(85) 3333-4444'
            })
        }
    }, [school, form])

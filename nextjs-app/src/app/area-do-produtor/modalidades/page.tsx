...
export default function ModalitiesPage() {
    ...
    const handleDuplicate = (modality: any) => {
        ...
        createModality({ ...rest, name: `${rest.name} (Cópia)` })
    ...
    const filteredModalities = modalities.filter((mod) => {
        ...
        const matchesSearch =
            ...
            (mod.maxAthletes || 0).toString().includes(searchLower) ||
            (mod.maxTeams || 0).toString().includes(searchLower) ||
            (mod.maxEventsPerAthlete || 0).toString().includes(searchLower)
        ...
        <div className="space-y-8 animate-fade-in relative">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    <Button
                        onClick={() => router.push('/area-do-produtor/modalidades/nova')}
                            ...
                            currentModalities.map((mod) => (
                                ...
                                >
                                    ...
                                    <TableCell className="text-muted-foreground h-12 py-0 text-center">
                                        {mod.minAge !== undefined && mod.maxAge !== undefined ? `${mod.minAge} - ${mod.maxAge} anos` : '-'}
                                    </TableCell>
                                    <TableCell className="text-muted-foreground h-12 py-0 text-center">
                                        {mod.minAthletes !== undefined && mod.maxAthletes !== undefined ? `${mod.minAthletes} - ${mod.maxAthletes}` : '-'}
                                    </TableCell>
                                    <TableCell className="text-muted-foreground h-12 py-0 text-center">
                                        {(mod.maxTeams || 0) > 0 ? mod.maxTeams : 'Ilimitado'}
                                    </TableCell>

...
export function DashboardHeader() {
    ...
    // Try to get eventId from params or parse it from pathname
    const eventId = params.eventId as string || pathname?.split('/evento/')[1]?.split('/')[0]
                        ...
                        <div className="p-6">
                            ...
                            <nav className="space-y-2">
                                <Button
                                    ...
                                    onClick={() => router.push('/area-do-produtor/inicio')}
                                >
                                    Visão Geral
                                </Button>
                                <Button
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-60 p-2" align="end" forceMount>
                        ...
                        <DropdownMenuItem
                            ...
                            onClick={() => router.push('/area-do-produtor/perfil')}
                        >
                            Perfil e Conta
                        </DropdownMenuItem>
                        <DropdownMenuItem
                            className="cursor-pointer"
                            onClick={() => router.push('/area-do-produtor/configuracoes')}
                        >
                            Configurações
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />

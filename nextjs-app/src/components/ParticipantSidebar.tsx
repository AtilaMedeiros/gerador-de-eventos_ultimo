...
export function ParticipantSidebar() {
    ...
    const isChildActive = (path: string) => pathname?.startsWith(path) || false
    ...
    return (
        <aside className="hidden w-64 flex-col border-r bg-sidebar text-sidebar-foreground md:flex min-h-screen sticky top-0 h-screen overflow-y-auto">
            <div className="p-6 border-b border-sidebar-border">
                <Link
                    href="/area-do-participante/inicio"
            ...
            <nav className="flex-1 p-4 space-y-1">
                ...
                <Link
                    href="/area-do-participante/escola"
                    className={cn(
                        'flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground group',
                ...
                >
                    <School className="h-5 w-5 text-muted-foreground group-hover:text-foreground transition-colors" />
                    Escola
                </Link>

                <Link
                    href="/area-do-participante/atletas"
                    className={cn(
                        'flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground group',
                ...
                <Link
                    href="/area-do-participante/fichas"
                    className={cn(
                        'flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground group',
                ...
                <div className="pt-4">
                    <Link
                        href="/area-do-participante/tecnicos"
                        className={cn(
                            'flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-sidebar-accent hover:text-sidebar-accent-foreground group',
            ...
            <div className="p-4 border-t border-sidebar-border">
                <button
                    ...
                    className="flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-destructive transition-colors hover:bg-destructive/10 w-full"
                >

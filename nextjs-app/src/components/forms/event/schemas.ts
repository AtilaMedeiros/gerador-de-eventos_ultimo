...
export const eventFormSchema = z
    .object({
        ...
        imagem: z.any().optional(), // Mudado de z.instanceof(File) para ser mais flexível com SSR/Hydration se necessário, mas manteremos a lógica
        logoEvento: z.any().optional(),
        logosRealizadores: z.any().optional(),
        logosApoiadores: z.any().optional(),

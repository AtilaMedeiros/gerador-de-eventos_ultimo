...
import { useEventTheme, ThemeValues } from '@/contexts/EventThemeContext'
...
export default function VisualIdentityForm({
    ...
    const id = isModal ? propThemeId : params.id as string
    const isEditing = !!id && id !== 'novo'
    const { addTheme, updateTheme, getThemeById } = useEventTheme()
    ...
    useEffect(() => {
        if (isClient && isEditing && id) {
            ...
            if (theme) {
                ...
                router.push('/area-do-produtor/identidade-visual')
            }
        }
    }, [isClient, isEditing, id, getThemeById, form, router])
                ...
                <div className="flex items-center gap-2">
                    {!isModal && (
                        <Button
                            ...
                            size="sm"
                            onClick={() =>
                                returnTo ? router.push(returnTo) : router.push('/area-do-produtor/identidade-visual')
                            }
                        >

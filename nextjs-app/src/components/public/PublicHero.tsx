...
import { Calendar, Ticket, ArrowRight, Users, MapPin, User, Share2 } from 'lucide-react'
                        ...
                        <li className="flex items-center gap-3 text-blue-50 text-sm md:text-base font-light group">
                            ...
                            <span className="group-hover:translate-x-1 transition-transform duration-300 capitalize">
                                {event.startDate.getMonth() === event.endDate.getMonth()
                                    ? `${format(event.startDate, 'dd')} a ${format(event.endDate, "dd 'de' MMMM 'de' yyyy", { locale: ptBR })}`
                        ...
                        {event.registrationIndividualEnd && (
                            <li className="flex items-center gap-3 text-blue-50 text-sm md:text-base font-light group">
                                ...
                                <div className="flex flex-col group-hover:translate-x-1 transition-transform duration-300">
                                    ...
                                    <span>
                                        Até {format(event.registrationIndividualEnd, "dd/MM/yyyy", { locale: ptBR })}
                                    </span>
                                </div>
                            </li>
                        )}
                        ...
                        {event.registrationCollectiveEnd && (
                            <li className="flex items-center gap-3 text-blue-50 text-sm md:text-base font-light group">
                                ...
                                <div className="flex flex-col group-hover:translate-x-1 transition-transform duration-300">
                                    ...
                                    <span>
                                        Até {format(event.registrationCollectiveEnd, "dd/MM/yyyy", { locale: ptBR })}
                                    </span>
                                </div>
                            </li>
                        )}

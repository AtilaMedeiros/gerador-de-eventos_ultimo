...
function useFilePreview(file: File | undefined | null) {
            ...
            <div className="absolute bottom-0 left-0 w-full p-6 md:p-10">
              <div className="container mx-auto flex flex-col md:flex-row gap-6 items-end">
                ...
                <div className="flex-1 space-y-2">
                  <Badge className="bg-success text-white hover:bg-success mb-2">
                    Inscrições Abertas
                  </Badge>
              ...
              <Card>
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="prose max-w-none text-muted-foreground whitespace-pre-wrap leading-relaxed">
                    {data.textoInstitucional ||
                      'Nenhuma informação institucional fornecida.'}
                  </div>
                </CardContent>
              </Card>
                    ...
                    {data.logosApoiadores?.length > 0 && (
                      <div className="space-y-3">
                        ...
                        <div className="flex flex-wrap justify-center gap-3 grayscale opacity-80 hover:grayscale-0 transition-all">
                          {data.logosApoiadores.map((file: File, i: number) => (
                            <div
                              key={`supporter-${i}`}

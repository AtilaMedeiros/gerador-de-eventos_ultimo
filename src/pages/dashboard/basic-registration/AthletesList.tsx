...
import { Search, Download, Plus, Edit, Trash2, User } from 'lucide-react'
        ...
        <div className="space-y-8 animate-fade-in relative">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    <Button
                        onClick={() => handleAction('Novo Atleta')}
                ...
                <Table>
                    <TableHeader className="bg-primary/5">
                        <TableRow className="hover:bg-transparent border-b border-blue-100 dark:border-blue-900/30">
                            ...
                            <TableHead className="font-semibold text-primary/80 h-12">Categoria</TableHead>
                            <TableHead className="font-semibold text-primary/80 h-12">Escola</TableHead>

...
export default function AthleteInscription() {
  ...
  const { athletes, inscriptions, addInscription, deleteInscription } =
    useParticipant()
  ...
  // Calculate age
  const age = athlete ? differenceInYears(new Date(), athlete.dob) : 0
      ...
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Atleta ou evento não encontrado.
          </p>
          <Button
            variant="outline"
            className="mt-4"
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold tracking-tight">
              Alocar/Vincular Modalidades ao Atleta
            </h2>
            <div className="flex items-center gap-2 text-muted-foreground text-sm mt-1">
              <User className="h-3 w-3" /> {athlete.name}
              <span className="text-border">|</span>
              <span>
                {age} anos ({athlete.sex})
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="bg-blue-50 text-blue-700 p-4 rounded-md text-sm flex gap-3 border border-blue-100">
            ...
            <div>
              ...
              <ul className="list-disc list-inside pl-1 mt-1">
                ...
                <li>Sexo do atleta ({athlete.sex})</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7">
          <Card className="h-full border-none shadow-none bg-transparent">
            <div className="mb-4">
              ...
              <p className="text-muted-foreground">
                Lista de modalidades vinculadas ao atleta para este evento.
              </p>
            </div>
              ...
              <Table>
                ...
                <TableBody>
                  {athleteInscriptions.length === 0 ? (
                    ...
                    athleteInscriptions.map((inscription) => {

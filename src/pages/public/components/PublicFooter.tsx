      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <div>
              <div className="h-12 w-12 bg-primary rounded-xl flex items-center justify-center text-white font-black text-xl mb-4 shadow-[0_0_20px_rgba(var(--primary),0.4)]">
                JE
              </div>
            ...
            <div className="flex gap-3">
              {[Facebook, Instagram, Twitter].map((Icon, i) => (
                <Button
                  ...
                  size="icon"
                  variant="outline"
                  className="rounded-full border-slate-800 bg-slate-900/50 hover:bg-primary hover:text-white hover:border-primary transition-all duration-300"
                >
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3 group">
                <div className="p-2 bg-slate-900 rounded-lg text-primary group-hover:bg-primary group-hover:text-white transition-colors">
